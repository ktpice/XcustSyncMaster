...
{
    public class XCustAPInvoiceWebService : Form
    {
        int gapLine = 5;
        ...
        ControlMain Cm;
        ControlAPInvoiceWebService cAPWS;
        private ListViewColumnSorter lvwColumnSorter;

        public XCustAPInvoiceWebService(ControlMain cm)
        {
        ...
        {
            cAPWS = new ControlAPInvoiceWebService(Cm);
            ...
            lb2.Text = lb2.Text + " " + Cm.xcustAPInvoiceWebService_run;
            if (Cm.xcustAPInvoiceWebService_run.ToLower().Equals("on"))
            {
        ...
        private void initCompoment()
        {
            ...
            lb2.Font = cAPWS.fV1;
            lb2.Text = "Program Name Xcust AP Invoice Transaction Webservice";
            lb2.AutoSize = true;
            Controls.Add(lb2);
