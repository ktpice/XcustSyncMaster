...
{
    public class XCustBuMstWebService: Form
    {
        int gapLine = 5;
        ...
        public XCustBuMstWebService(ControlMain cm)
        {
        ...
        private void initConfig()
        {
            ...
            txtFileName.Text = Cm.initC.AutoBuMaster;
            ...
            lb2.Text = lb2.Text + " " + Cm.xcustbumstwebservice_run;
            if (Cm.xcustbumstwebservice_run.ToLower().Equals("on"))
            {
        ...
        private void initCompoment()
        {
            ...
            lb1.AutoSize = true;
            Controls.Add(lb1);
            lb1.Location = new System.Drawing.Point(cIBuWS.formFirstLineX, cIBuWS.formFirstLineY + gapLine);

            lb2 = new MaterialLabel();
            lb2.Font = cIBuWS.fV1;
            lb2.Text = "Program Name XcustBuMst Web";
            lb2.AutoSize = true;
            Controls.Add(lb2);
            lb2.Location = new System.Drawing.Point(grd3, cIBuWS.formFirstLineY + gapLine);

            txtFileName = new MaterialSingleLineTextField();
            txtFileName.Font = cIBuWS.fV1;
            txtFileName.Text = "";
            txtFileName.Size = new System.Drawing.Size(300 - grd1 - 20 - 30, ControlHeight);
            Controls.Add(txtFileName);
            txtFileName.Location = new System.Drawing.Point(grd1, cIBuWS.formFirstLineY + gapLine);
            ...
            pB1.Location = new System.Drawing.Point(cIBuWS.formFirstLineX + 5, line41);

            lv1 = new MaterialListView();
            lv1.Font = cIBuWS.fV1;
            lv1.FullRowSelect = true;
            lv1.Size = new System.Drawing.Size(formwidth - 40, formheight - line3 - 100);
            lv1.Location = new System.Drawing.Point(cIBuWS.formFirstLineX + 5, line42);
            lv1.FullRowSelect = true;
