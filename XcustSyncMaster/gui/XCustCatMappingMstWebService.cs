...
{
    public class XCustCatMappingMstWebService : Form
    {
        int gapLine = 5;
        ...
        public XCustCatMappingMstWebService(ControlMain cm)
        {
        ...
        private void initConfig()
        {
            ...
            txtFileName.Text = Cm.initC.AutoCatMappingMaster;
            ...
            lb2.Text = lb2.Text + " " + Cm.xcustCatMappingwebservice_run;
            if (Cm.xcustCatMappingwebservice_run.ToLower().Equals("on"))
            {
        ...
        private void initCompoment()
        {
            ...
            lb1.Font = cICatmWS.fV1;
            lb1.Text = "Text File";
            lb1.AutoSize = true;
            Controls.Add(lb1);
            lb1.Location = new System.Drawing.Point(cICatmWS.formFirstLineX, cICatmWS.formFirstLineY + gapLine);

            lb2 = new MaterialLabel();
            lb2.Font = cICatmWS.fV1;
            lb2.Text = "Program Name Xcust Category Mapping Mst Web";
            lb2.AutoSize = true;
            Controls.Add(lb2);
            lb2.Location = new System.Drawing.Point(grd3, cICatmWS.formFirstLineY + gapLine);

            txtFileName = new MaterialSingleLineTextField();
            txtFileName.Font = cICatmWS.fV1;
            txtFileName.Text = "";
            txtFileName.Size = new System.Drawing.Size(300 - grd1 - 20 - 30, ControlHeight);
            Controls.Add(txtFileName);
            txtFileName.Location = new System.Drawing.Point(grd1, cICatmWS.formFirstLineY + gapLine);
            ...
            pB1.Location = new System.Drawing.Point(cICatmWS.formFirstLineX + 5, line41);

            lv1 = new MaterialListView();
            lv1.Font = cICatmWS.fV1;
            lv1.FullRowSelect = true;
            lv1.Size = new System.Drawing.Size(formwidth - 40, formheight - line3 - 100);
            lv1.Location = new System.Drawing.Point(cICatmWS.formFirstLineX + 5, line42);
            lv1.FullRowSelect = true;
