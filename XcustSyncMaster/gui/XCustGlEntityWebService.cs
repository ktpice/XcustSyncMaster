...
{
    public class XCustGlEntityWebService: Form
    {
        int gapLine = 5;
        ...
        public XCustGlEntityWebService(ControlMain cm)
        {
        ...
        private void initConfig()
        {
            ...
            lv1.Sort();
            txtFileName.Text = Cm.initC.AutoGlEntity;
            ...
            lb2.Text = lb2.Text + " " + Cm.xcustGLEntitywebservice_run;
            if (Cm.xcustGLEntitywebservice_run.ToLower().Equals("on"))
            {
        ...
        private void initCompoment()
        {
            ...
            lb1.AutoSize = true;
            Controls.Add(lb1);
            lb1.Location = new System.Drawing.Point(cGlWS.formFirstLineX, cGlWS.formFirstLineY + gapLine);

            lb2 = new MaterialLabel();
            lb2.Font = cGlWS.fV1;
            lb2.Text = "Program Name Xcust GL Entity Webservice";
            lb2.AutoSize = true;
            Controls.Add(lb2);
            lb2.Location = new System.Drawing.Point(grd3, cGlWS.formFirstLineY + gapLine);

            txtFileName = new MaterialSingleLineTextField();
            txtFileName.Font = cGlWS.fV1;
            txtFileName.Text = "";
            txtFileName.Size = new System.Drawing.Size(300 - grd1 - 20 - 30, ControlHeight);
            Controls.Add(txtFileName);
            txtFileName.Location = new System.Drawing.Point(grd1, cGlWS.formFirstLineY + gapLine);
            ...
            pB1.Location = new System.Drawing.Point(cGlWS.formFirstLineX + 5, line41);

            lv1 = new MaterialListView();
            lv1.Font = cGlWS.fV1;
            lv1.FullRowSelect = true;
            lv1.Size = new System.Drawing.Size(formwidth - 40, formheight - line3 - 100);
            lv1.Location = new System.Drawing.Point(cGlWS.formFirstLineX + 5, line42);
            lv1.FullRowSelect = true;
